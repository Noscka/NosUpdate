...
// not addressed here
class BOOST_SYMBOL_VISIBLE portable_binary_iarchive :
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE(NosUpdate::BoostExpand::portable_binary_iarchive)
#endif

// required by export in boost <= 1.34
#define BOOST_ARCHIVE_CUSTOM_IARCHIVE_TYPES NosUpdate::BoostExpand::portable_binary_iarchive
