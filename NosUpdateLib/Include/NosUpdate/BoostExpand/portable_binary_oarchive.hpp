...
class BOOST_SYMBOL_VISIBLE portable_binary_oarchive :
...
BOOST_SERIALIZATION_REGISTER_ARCHIVE(NosUpdate::BoostExpand::portable_binary_oarchive)
#endif

// required by export in boost <= 1.34
#define BOOST_ARCHIVE_CUSTOM_OARCHIVE_TYPES NosUpdate::BoostExpand::portable_binary_oarchive
